 ...
 * @create 2017-09-19
 */
public class ProductByIdCacheManager extends AbstractCacheManager<Long, DefaultProduct> {

    private ProductLoader productLoader;

    public ProductByIdCacheManager(CachePolicy cachePolicy, DormantCacheCleaner cleaner, ProductLoader productLoader) {
        super(cachePolicy, cleaner);
        this.productLoader = productLoader;
    }

    @Override
    protected DefaultProduct loadSource(Long productId) throws ErrorCodeException {
        try{
    ...
    @Override
    protected DefaultProduct reloadSource(Long productId, DefaultProduct oldSource) throws ErrorCodeException {
        try{
