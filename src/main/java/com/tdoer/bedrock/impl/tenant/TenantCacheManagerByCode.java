 ...
 * @create 2017-09-19
 */
public class TenantCacheManagerByCode extends AbstractCacheManager<String, DefaultTenant> {

    private TenantLoader tenantLoader;

    public TenantCacheManagerByCode(CachePolicy cachePolicy, DormantCacheCleaner cleaner, TenantLoader tenantLoader) {
    ...
    protected DefaultTenant loadSource(String tenantCode) throws ErrorCodeException {
        try{
            ...
            DefaultTenant ret = tenantLoader.loadTenant(tenantCode);
