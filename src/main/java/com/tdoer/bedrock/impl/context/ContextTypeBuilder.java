 ...
 * @create 2017-09-19
 */
public class ContextTypeBuilder {

    DefaultContextType buildContextType(ContextTypeDefinition definition){
        return buildContextType(definition, null);
    }

    DefaultContextType buildContextType(ContextTypeDefinition definition, DefaultContextType parent){
